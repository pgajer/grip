...
or three-dimensional. The original GRIP study reported smoother, more symmetric
drawings obtained by projecting higher-dimensional layouts; its Möbius-strip
examples compare layouts constructed directly in three dimensions with
four-dimensional layouts projected to three dimensions [@gajer2004].
