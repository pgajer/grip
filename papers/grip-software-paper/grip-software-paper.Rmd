...
generators provide examples, software regression tests, and controlled benchmarks.
...
per pair; its alternative tie mode averages exactly over tied input geodesics.
