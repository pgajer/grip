...
As a workflow guide, use `grip.layout()` on the purely topological versions of
these families when you want an unweighted baseline, and use
`grip.layout.weighted()` on the weighted bundles when the induced geometry is
...
mesh.coords <- grip.layout.weighted(
  mesh.graph$edges,
  n = mesh.graph$n,
...
torus.coords <- grip.layout.weighted(
  torus.graph$edges,
  n = torus.graph$n,
...
vicsek.coords <- grip.layout.weighted(
  vicsek.graph$edges,
  n = vicsek.graph$n,
...
annulus.coords <- grip.layout.weighted(
  annulus.graph$edges,
  n = annulus.graph$n,
...
cube.coords <- grip.layout.weighted(
  cube.graph$edges,
  n = cube.graph$n,
