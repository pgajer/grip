...
This benchmark shows a different pattern from the karate graph: once the graph
has a strong family structure, `grip` benefits from that structure through the
family-tuned preset. At the same time, stress and KK remain very strong on a
regular lattice.
