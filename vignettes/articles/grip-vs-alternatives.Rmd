...
- the historical legacy solver,
- the current quality-first GRIP engine,
...
Those are used in the second half of this article.
...
- optional LGKK-based refinement
...
- weighted GRIP plus LGKK polish improves it further.
