...
grip_weighted_nd_gflow_refinement_step_trace_run <- function(
  ...
  legacy <- legacy_cpp(
    ...
    coarse_repulsion_factor = as.double(tuning$coarse_repulsion_factor),
    coarse_repulsion_sample = as.integer(tuning$coarse_repulsion_sample),
    coarse_repulsion_exact_below = as.integer(tuning$coarse_repulsion_exact_below),
