...
**grip** is an R package for generating graph layouts, assessing how
faithfully they preserve graph distances, and refining them through
experimental graph-geodesic multidimensional scaling (GMDS) workflows.

Its assessments distinguish straight-line distances between embedded
vertices from lengths measured along retained graph paths. This allows
users to evaluate both conventional MDS fidelity and fixed-path GMDS
fidelity, including for coordinates generated by other software.
...
The package ships with six vignettes, available through
