...
- **Selecting Layouts on the Coarsened HMP/U01 Graph** — layout
  selection on a bundled 1,828-vertex microbial graph derived from the
  Human Microbiome Project, demonstrating the full comparison pipeline
