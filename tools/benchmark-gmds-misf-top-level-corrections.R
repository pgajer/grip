...
tex_path <- file.path(design_root, "pdf", "gmds_misf_top_level_corrections_report_2026-04-02.tex")
pdf_path <- file.path(design_root, "pdf", "gmds_misf_top_level_corrections_report_2026-04-02.pdf")
