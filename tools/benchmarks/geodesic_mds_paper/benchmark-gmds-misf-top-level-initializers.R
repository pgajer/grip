...
tex_path <- file.path(design_root, "reports", "gmds_misf_top_level_initializer_report_2026-04-02.tex")
pdf_path <- file.path(design_root, "reports", "gmds_misf_top_level_initializer_report_2026-04-02.pdf")
...
overall_lines <- c(
  ...
  paste(
    ...
    "\\texttt{tools/reports/geodesic_mds_paper/render-gmds-misf-top-level-initializers-html.R}.",
