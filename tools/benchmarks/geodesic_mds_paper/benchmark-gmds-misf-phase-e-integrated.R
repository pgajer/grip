...
tex_path <- file.path(design_root, "reports", "gmds_misf_phase_e_integrated_report_2026-04-02.tex")
pdf_path <- file.path(design_root, "reports", "gmds_misf_phase_e_integrated_report_2026-04-02.pdf")
