...
tex_path <- file.path(manual_root, "reports", "gmds_v2_paraboloid_regularized_report_2026-04-01.tex")
pdf_path <- file.path(manual_root, "reports", "gmds_v2_paraboloid_regularized_report_2026-04-01.pdf")
