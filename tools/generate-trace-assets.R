...
carpet4_trace_2d_v5 <- grip.layout.trace(carpet4,
                                         n = max(carpet4),
                                         dim = 2,
                                         engine = "mish_v5",
                                         placement = "barycenter",
...
plot_2d_trace_gif(file.path(fig_dir, "trace-sierpinski-carpet-level-4-2d.gif"),
                  ...
                  fps = 5,
                  final_hold_sec = 5)
plot_2d_trace_gif(file.path(fig_dir, "trace-sierpinski-carpet-level-4-2d-mish-v5.gif"),
                  carpet4_trace_2d_v5,
                  carpet4,
                  title_text = "Sierpinski Carpet (Level 4, 2D Trace, mish_v5)",
                  fps = 5,
                  final_hold_sec = 5)
