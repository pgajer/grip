...
tex_path <- file.path(manual_root, "pdf", "gmds_misf_seeded_pipeline_report_2026-04-02.tex")
pdf_path <- file.path(manual_root, "pdf", "gmds_misf_seeded_pipeline_report_2026-04-02.pdf")
...
tex_lines <- c(
  ...
  paste(
    ...
    "\\texttt{tools/render-gmds-misf-seeded-pipeline-html.R}.",
