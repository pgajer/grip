...
#' Legacy weighted GRIP layout
#'
#' \code{grip.layout.weighted.legacy()} keeps the original 2D/3D weighted GRIP
#' implementation available after \code{\link{grip.layout.weighted}()} moved to
#' the dimension-general weighted backend.
#'
#' @inheritParams grip.layout.globalrep.weighted
#' @return A numeric matrix with \code{n} rows and \code{dim} columns.
#' @export
grip.layout.weighted.legacy <- function(edges = NULL,
                                        n = NULL,
                                        adj_list = NULL,
                                        weight_list = NULL,
                                        edge_weights = NULL,
