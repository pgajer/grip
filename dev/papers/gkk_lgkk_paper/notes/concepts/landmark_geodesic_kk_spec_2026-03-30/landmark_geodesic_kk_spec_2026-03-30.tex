...
\author{Codex design note for the \filepath{<repo-root>} repository}
\date{March 30, 2026}
...
\begin{itemize}[leftmargin=1.4em]
  \item \filepath{<repo-root>/src/MishSupport.cpp}
    (\code{bfs\_me\_v4()} and \code{KK\_spring\_local()}),
  \item \filepath{<repo-root>/src/DrawGraph.cpp}
    (\code{initial\_position\_barycenter()} and
    \code{initial\_position\_circle()}),
  \item \filepath{<repo-root>/src/MishEngine.cpp}
