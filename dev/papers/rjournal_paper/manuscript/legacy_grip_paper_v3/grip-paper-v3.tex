...
\hline
landmark.geodesic.kk & grip.prepare/score/optimize.landmark.geodesic.kk() & Sparse landmark geodesic-KK approximation used for post-polish and scalable weighted refinement.\\
\hline
misf.geodesic.kk & grip.prepare/score/optimize.misf.geodesic.kk() & MISF-based multiscale geodesic-KK family for coarse-to-fine weighted optimization, refinement, and scoring.\\
\hline
misf.geodesic.mds & grip.prepare/score/optimize.misf.geodesic.mds() & MISF-based geodesic-MDS family for multiscale weighted embedding under a related geodesic stress objective.\\
\hline
\end{tabular}
\end{table}
...
keeps the main focus on the \texttt{grip.layout*()} interfaces, because they remain
the clearest user-facing expression of the package's main strength: fast 2D and
3D graph layout at practical runtime scale.

For advanced users, \texttt{grip.prepare/score/optimize.misf.geodesic.kk()} now
...
\hline
20x20 torus & 3 & 400 & 800 & Single 3D preset solve & 0.343 & 35.709\\
\hline
...
\hline
12x12 mesh & default & 3 & 0.616 & 41.956 & 0.122 & 0.134 & 0.490\\
\hline
12x12 mesh & mesh & 3 & 0.671 & 19.785 & 0.050 & 1.214 & 0.005\\
\hline
Carpet level 3 & default & 3 & 0.219 & 133.750 & 0.208 & 0.048 & 0.562\\
\hline
Carpet level 3 & carpet & 3 & 0.605 & 54.504 & 0.120 & 1.090 & 0.014\\
\hline
\end{tabular}
\end{table}
...
still the practical one: \texttt{grip.layout*()} makes fast multiscale 2D and 3D
